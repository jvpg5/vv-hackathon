...
export interface ApiLocalLocal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria: Schema.Attribute.Enumeration<
      ['cultura', 'gastronomia', 'historia', 'evento', 'turismo', 'outro']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    descricao_longa: Schema.Attribute.Text;
    ...
    pontuacao: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    qr_code_id: Schema.Attribute.UID;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPremioPremio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nome: Schema.Attribute.String & Schema.Attribute.Required;
    pontos_necessarios: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    premios: Schema.Attribute.Relation<'oneToMany', 'api::premio.premio'>;
